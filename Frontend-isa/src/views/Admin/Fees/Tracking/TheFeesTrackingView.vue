<template>
  <div class="luxury-container">
    <div v-if="!route.params.filiere" class="luxury-selection">
        ...
        <div class="institute-crest">
          <div class="crest-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="crest-svg">
              ...
              <path class="crest-base" d="M50 5L5 30v40l45 25 45-25V30L50 5z" fill="url(#instituteBlue)" />
              <path class="crest-detail" d="M50 35L30 45v20l20 10 20-10V45L50 35z" fill="url(#instituteGreen)" />
...
function goToFiliere(filiere: string) {
  router.push(`/admin/suivi-paiements/${filiere.toLowerCase()}`);
}
