        ...
        <header class="levels-header">
            ...
            <div class="header-content">
                <h1 class="luxury-title">
                    <span class="title-main">Parcours Académique</span>
                    <span class="title-subtitle">{{ getFieldName(route.params.field as string) }}</span>
                </h1>
...
function selectLevel(niveau: any) {
    ...
    router.push(`/admin/grades/${route.params.field}/${niveau.value}`);
}
