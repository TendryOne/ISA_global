  ...
  <div class="module-item-luxury" :class="{ completed: isCompleted }">
    <div class="luxury-card">
      ...
      <div class="actions-section">
        ...
        <ActionButton icon="mdi:eye" @click="
          router.push(
            `/student/courses/${route.params.semester}/${route.params.promotionId}/${module.moduleId}`,
          )
          " full-width variant="outline" outline-color="prim">
          Voir le module
        </ActionButton>
      </div>
    </div>
    ...
    <div v-if="showSessionModal" class="modal-overlay" @click.self="closeSessionModal">
      <div class="modal-content">
          ...
          <div class="sessions-list">
            ...
            <div v-for="(session, index) in module.sessions" :key="index" class="session-item"
              ...
              <div class="session-details">
                ...
                <div class="session-duration">{{ session.duration }} heures</div>
              </div>
        ...
        <div class="modal-footer">
          <button class="luxury-button secondary" @click="closeSessionModal">Fermer</button>
        </div>
      </div>
    </div>
  </div>
