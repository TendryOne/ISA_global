<template>
  <div class="schedule-container">
    ...
    <!-- Modal détails cours -->
    <TheScheduleModalViewForProfessor :is-open="!!selectedSchedule" :course="selectedSchedule"
      @close="selectedSchedule = null" :promotions="availablePromotions" />
...
import TheScheduleModalViewForProfessor from './TheScheduleModalViewForProfessor.vue'
...
const getWeekSchedules = async () => {
  try {
    ...
    const response = (await axios.get(`/api/v1/schedules/professor/${userStore.currentUser._id}`, {
      params: {
